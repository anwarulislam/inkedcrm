...
export class CreateScheduleComponent implements OnInit {
  ...
  addSchedule(){
    ...
    data.startDateStr = `${data.startDateStr.getDate()}/${data.startDateStr.getMonth()+1}/${data.startDateStr.getFullYear()}`;
    data.endDateStr = `${data.endDateStr.getDate()}/${data.endDateStr.getMonth()+1}/${data.endDateStr.getFullYear()}`;
    ...
    if(!this.data.edit){
      this._apiService.PostData('event','saveEvent',data).subscribe((res:any)=>{
        console.log(res)
        this.form.reset();
      ...
      console.log(data)
      this._apiService.PutData('event',`updateEvent/${this.data.data.eventID}`,data).subscribe((res:any)=>{
        console.log(res)
        this.form.reset();
        this._dialogRef.close(true);
      },err=>{
