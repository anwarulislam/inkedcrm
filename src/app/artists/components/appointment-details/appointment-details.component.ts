...
export class AppointmentDetailsComponent implements OnInit {
  ...
  constructor(
    ...
    let startDatePerfect = new Date(`${dateStart[2]}-${dateStart[1]}-${dateStart[0]}T${data.appointment.startTime}:00`);
    let endDatePerfect = new Date(`${dateEnd[2]}-${dateEnd[1]}-${dateEnd[0]}T${data.appointment.endTime}:00`);
